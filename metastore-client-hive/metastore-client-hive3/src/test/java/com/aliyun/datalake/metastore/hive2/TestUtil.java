...
public class TestUtil {
    ...
    public static Table getPartitionTable(
        ...
        List<FieldSchema> pKeys = partKeys.entrySet().stream()
    ...
    public static Table buildTable(String databaseName, String tableName) {
        return buildTable(databaseName, tableName, MANAGED_TABLE_TYPE);
    }

    public static Table buildTable(String databaseName, String tableName, String tableType) {
        return buildTable(databaseName, tableName, Lists.newArrayList("day"), tableType);
    }
    ...
    public static class DatabaseBuilder {
        ...
        private DatabaseBuilder() {
            ...
            database.setCatalogName(DEFAULT_CATALOG_NAME);
