...
public class DlfMetaStoreClientFactory implements HiveMetaStoreClientFactory {
    ...
    public IMetaStoreClient createMetaStoreClient(
        ...
        if (hiveConf.getBoolVar(HiveConf.ConfVars.METASTORE_FASTPATH)) {
            ...
            return RetryingMetaStoreClient.getProxy(hiveConf, new Class[]{HiveConf.class, HiveMetaHookLoader.class, Boolean.class}, new Object[]{hiveConf, hiveMetaHookLoader, allowEmbedded}, metaCallTimeMap, ProxyMetaStoreClient.class.getName());
        }
    }
}
